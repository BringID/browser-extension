...
import {NotarizationHandler, NotarizationStatus, ResultCallback} from "./types";
import {OnStateUpdated, Progressive} from "../../common/helpers/progressive";
import {Presentation} from "tlsn-js";

export abstract class NotarizationBase extends Progressive<NotarizationStatus> implements NotarizationHandler {
    ...
    public async start(resultCallback: ResultCallback, updatesCallback?: OnStateUpdated<NotarizationStatus>): Promise<void> {
